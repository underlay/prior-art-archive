			...
			<div className={'container narrow'}>
				<div className={'row'}>
					<div className={'col-12'}>
						...
						<ul>
							<li>
								Customized Parser Algorithm to meet USPTO needs. No additional training is required for USPTO examiners. USPTO can use their complete existing set of operators and search strings to search content.</li>
							<li>
								Uploaded documents are machine-classified with CPCs by Google <a href="https://publicpolicy.googleblog.com/2015/07/good-patents-support-innovation-while.html">https://publicpolicy.googleblog.com/2015/07/good-patents-support-innovation-while.html</a>
							</li>
							<li>
						...
						<h2>How to Join</h2>
						<p>Simply send your inquiries and request to join at <a href="mailto:priorartarchive@media.mit.edu">priorartarchive@media.mit.edu</a></p>

						<h2>How it Works</h2>
						<ul>
							<li>If you have any content in the digital format, simply collect and upload it using the secured FTP server.</li>
							<li>You will be assigned a unique secured FTP user id and password. Simply upload your documents to the secured FTP server and your documents will be available for USPTO.</li>
							<li>Also, you should get your old paper technical documentation ready in the digital formats (word, pdf, images, web pages, excel, text, and video)</li>
							<li>Your content will be also made available to other search engines like Google & Bing so that it is found in the public domain via public search engines. </li>
							<li>Site is public and it can be used by innovators and law firms to review prior innovations and documents before they file their patent requests with USPTO.</li>
							<li>
						...
						<pre><b>Host</b>: sftp.priorartarchive.org</pre>
						<pre><b>Port</b>: 2222</pre>
						<pre><b>Protocol</b>: SFTP</pre>
						<pre><b>User</b>: &lt;Your Username - assigned once you join the efforts&gt;</pre>
						<pre><b>Password</b>: &lt;Your API Key - assigned once you join the efforts&gt;</pre>
						<br />
