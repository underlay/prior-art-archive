				...
				<div className={'row'}>
					<div className={'col-12'}>
						...
						<ul>
							...
							<li>The NEAR operator searches for terms that are next to each other (distance=0)</li>
							<li>
								...
								<div className="example">Ex: cisco ADJ router will become ONEAR(cisco, router)</div>
							</li>
							<li>
								WITH Operator will search for terms within a distance of 15.
								<div className="example">Ex: cisco WITH router will become NEAR(cisco, router, distance=15)</div>	
							</li>
							<li>
								SAME Operator will search for the terms within a distance of 200.
								<div className="example">Ex: cisco SAME router will become NEAR(cisco, router, distance=200)</div>
							</li>
							<li>
							...
							<li>
								...
								<div className="example">Ex: config$5 will become config[a-zA-Z0-9]{'{'}0,5{'}'}</div>
							</li>
							<li>
								...
								<div className="example">Ex: cisco~4 will become FUZZY(cisco, similarity=4)</div>
							</li>
							<li>
								...
								<div className="example">Ex: cisco^100 will become TERM(cisco, BOOST=100)</div>
							</li>
							<li>
								'|' if used in search text will be interpreted as 'OR' operator.
								<div className="example">Ex: cisco|router will become OR(cisco, router)</div>
							</li>
							<li>
						...
						<ul>
							<li>
								...
								<div className="example">Ex: cisco.ti. will become title:cisco</div>
								<div className="example">Ex: cisco.ab. will become description:cisco</div>
								<div className="example">Ex: A comma will need to separate a search on the title and abstract. cisco.ti,ab. will become OR(CONTEXT(title):cisco, CONTEXT(description):cisco)</div>
								<div className="example">Ex: cisco AND 799/11.ccls will become cisco</div>
							</li>
							<li>
								For following extensions, strings associated will be retained as normal string in the search text.	
								<br />ASGP, AS, INGP, IN
								<div className="example">Ex: cisco AND marker.ASGP will become cisco AND marker</div>	
							</li>
							<li>
								For following extensions the string will be converted to date format.
								<br />AD, FD, AY, FY, PPPD, PD, ISD ,PY, ISY
								<div className="example">Ex: 19961011.AD will become date:[1996-10-11T00:00:00 TO 1996-10-11T23:59:59]</div>
							</li>
							<li>
